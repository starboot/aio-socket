...
public class MemoryCell {
     ...
     */
    private final MemoryChunk bufferPage;
    ...
    MemoryCell(MemoryChunk bufferPage, ByteBuffer buffer, int parentPosition, int parentLimit) {
     ...
     * @return       虚拟内存类型的数据
     */
    public static MemoryCell wrap(ByteBuffer buffer) {
        return new MemoryCell(null, buffer, 0, 0);
    }
